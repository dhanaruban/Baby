 ...
 * objects.
 */
public class DetectorOldActivity extends CameraTFActivity implements OnImageAvailableListener {

  private static final String TAG = DetectorOldActivity.class.getName();
