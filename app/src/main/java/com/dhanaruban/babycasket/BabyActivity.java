...
public class BabyActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerViewTasks2);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                Uri uri = BabyContract.TaskEntry.CONTENT_URI;
                ...
                getSupportLoaderManager().restartLoader(TASK_LOADER_ID, null, BabyActivity.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent addPhoto = new Intent(getApplicationContext(),AddBabyActivity.class);
    ...
    public Loader<Cursor> onCreateLoader(int id, final Bundle loaderArgs) {
        ...
        return new AsyncTaskLoader<Cursor>(this) {
            ...
            public Cursor loadInBackground() {
                ...
                try {
                    return getContentResolver().query(BabyContract.TaskEntry.CONTENT_URI,
                            null,
                            null,
                            null,
                            BabyContract.TaskEntry.COLUMN__BABY_IMAGE);
