...
public class ObjectContract {
    ...
    public static final String AUTHORITY = "com.dhanaruban.babycasket.AddObjectActivity";
    ...
    public static final String PATH_TASKS = "objectitems";
    ...
    public static final class TaskEntry implements BaseColumns {
        ...
        public static final String COLUMN_OBJECT_IMAGE = "objectimage";
        public static final String UPLOAD_OBJECT_STATUS = "uploadobjectstatus";
